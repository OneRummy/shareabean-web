import { ShoppingCart, Home, MessageSquare, Bookmark, User, Search, MapPin, Bell, Heart, ChevronDown, Eye } from 'lucide-react';
  ...
  const categories = [
    {
      ...
      name: '식료품',
      icon: '🥗',
      image: 'https://images.unsplash.com/photo-1668295037389-292efc20dafe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx3aGl0ZSUyMG9uaW9uJTIwZnJlc2glMjB2ZWdldGFibGV8ZW58MXx8fHwxNzU3NTg5NjI4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
    },
    {
      id: 'electronics',
      name: '전자제품',
      icon: '📱',
      image: 'https://images.unsplash.com/photo-1636614223954-db6a663293ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbGVjdHJvbmljcyUyMGdhZGdldHMlMjB0ZWNobm9sb2d5fGVufDF8fHx8MTc1NzUyNTQzNXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
    },
    {
      id: 'stationery',
      name: '문구',
      icon: '✏️',
      image: 'https://images.unsplash.com/photo-1612599316791-451087c7fe15?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvZmZpY2UlMjBzdXBwbGllcyUyMHN0YXRpb25lcnl8ZW58MXx8fHwxNzU3NTA3ODkyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
    },
    {
      id: 'kitchen',
      name: '주방',
      icon: '🍳',
      image: 'https://images.unsplash.com/photo-1730597363352-0a8fe6eb5d12?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxraXRjaGVuJTIwdXRlbnNpbHMlMjBjb29raW5nfGVufDF8fHx8MTc1NzU4OTYzOXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral'
    }
  ];
