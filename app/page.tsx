...
export default function App() {
  ...
  if (currentView === "list") {
    return <GroupPurchaseList onItemClick={handleItemClick} onNavigate={handleNavigate} activeTab={activeTab} />
  }

  return <HomePage onItemClick={handleItemClick} onNavigate={handleNavigate} activeTab={activeTab} />
}
